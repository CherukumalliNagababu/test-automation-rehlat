...
public class MultiCityPage {
	...
	String SelectedFromCity2;
	String SelectedToCity2;
	...
	@FindBy(id = "autoFlyingFrom2")
	private WebElement txtFlyFrom2;
	@FindBy(id = "autoFlyingTo2")
	private WebElement txtFlyTo2;
	...
	@FindBy(css = ".calendar-days.flex-container.flex-center.ng-scope")
	private List<WebElement> allDates;
	
	@FindBy(id = "Fromdated2")
	private WebElement btnDateFrom2;
	@FindBy(xpath = "//div[@class='fa fa-chevron-right']")
	private WebElement dateIconBtnFrom2;
	@FindBy(css = ".calendar-days.flex-container.flex-center.ng-scope")
	...
	public void enterFromAndToCityNames(Map<String, String> dataMap) throws InterruptedException {
		...
		selectmonth();
		selectDate();
		//MultiCity From City 2
		String fromCity2 = dataMap.get("fromCity1");
		String toCity2 = dataMap.get("toCity1");
		pageUtils.sendKeysAfterClearingElement(driver, txtFlyFrom2, fromCity2);
		pageUtils.waitForFixedTime(BrowserConstants.WAIT_SMALL_ENGINE);
		txtFlyFrom2.sendKeys(Keys.TAB);
		String userSelectFromValue2 = txtFlyFrom2.getAttribute("value");
		String[] getTextFrom2 = DataUtils.splitString(userSelectFromValue2, " ");
		SelectedFromCity2 = getTextFrom2[0];
		pageUtils.sendKeysAfterClearingElement(driver, txtFlyTo2, toCity2);
		pageUtils.waitForFixedTime(BrowserConstants.WAIT_SMALL_ENGINE);
		txtFlyTo2.sendKeys(Keys.TAB);
		String userSelectToValue2 = txtFlyTo2.getAttribute("value");
		String[] getTextTo2 = DataUtils.splitString(userSelectToValue2, " ");
		SelectedToCity2 = getTextTo2[0];
		selectmonth1();
		selectDate1();
	}
	...
	public void selectmonth1() throws InterruptedException {
		pageUtils.waitForFixedTime(BrowserConstants.WAIT_VERY_SMALL_ENGINE);
		pageUtils.clickElement(driver, btnDateFrom2);
		//for (int i = 0; i < 2; i++) {
			//pageUtils.clickElement(driver, dateIconBtnFrom2);
		//}
	}
	/**
