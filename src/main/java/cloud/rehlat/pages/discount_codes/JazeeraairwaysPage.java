...
public class JazeeraairwaysPage {
	...
	public JazeeraairwaysPage(WebDriver driver) {
	...
	@FindBy(xpath = ".//*[@id='destination_holder']/li/span")
	...
	public void searchResults()
		...
		FileInputStream fi = new FileInputStream(System.getProperty("user.dir")+
				"/src/main/resources/cloud/Rehlat/documents/Flights/Jazeera FromCity.xls");
		Workbook wb = Workbook.getWorkbook(fi);
		Sheet s = wb.getSheet("Sheet1");

		FileOutputStream fo = new FileOutputStream(System.getProperty("user.dir")+
				"/src/main/resources/cloud/Rehlat/documents/Flights/Jazeera FromCity_Results.xls");
